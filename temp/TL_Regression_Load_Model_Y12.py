...
def execute_model(filename, delimiter=','):
    ...
    return sklearn.metrics.mean_absolute_error(Y_test,y_pred), sklearn.metrics.mean_squared_error(Y_test,y_pred)), math.sqrt(sklearn.metrics.mean_squared_error(Y_test,y_pred))), sklearn.metrics.r2_score(Y_test,y_pred))
