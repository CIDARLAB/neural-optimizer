...
### Droput to avoid further over-fitting
#model.add(Dropout(0.3))
model.add(Dense(units = 8, activation = 'relu', name='scratch_dense_3'))#, kernel_regularizer=regularizers.l2(0.001))) #more options to avoid over-fitting
### Droput to avoid further over-fitting
#model.add(Dropout(0.3))
### Adding the output layer
model.add(Dense(units = 1, name='scratch_dense_4'))#, kernel_regularizer=regularizers.l2(0.001)))
...
print("\n")
print("Mean absolute error (MAE) for total data-set:      %f" % sklearn.metrics.mean_absolute_error(Y21,y_pred_total))
print("Mean squared error (MSE) for total data-set:       %f" % sklearn.metrics.mean_squared_error(Y21,y_pred_total))
print("Root mean squared error (RMSE) for total data-set: %f" % math.sqrt(sklearn.metrics.mean_squared_error(Y21,y_pred_total)))
print("R square (R^2) for total data-set:                 %f" % sklearn.metrics.r2_score(Y21,y_pred_total))