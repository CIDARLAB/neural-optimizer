...
model.add(Dense(units = 32, activation = 'relu', input_dim = 8 , name='dense_1'))#, kernel_regularizer=regularizers.l2(0.001))) #more options to avoid over-fitting
...
result = model.fit(X_train, Y_train, validation_data=(X_test, Y_test), batch_size = 16, epochs = 600, callbacks=[earlystopping])
...
# Save model weights
model.save_weights('Y11_weights.h5')
