...
model.add(Dense(units = 32, activation = 'relu', input_dim = 8 , name='scratch_dense_1'))#, kernel_regularizer=regularizers.l2(0.001))) #more options to avoid over-fitting
### Droput to avoid further over-fitting
#model.add(Dropout(0.3))
### Adding the output layer
model.add(Dense(units = 1, name='scratch_dense_2'))#, kernel_regularizer=regularizers.l2(0.001)))
...
result = model.fit(X_train, Y_train, validation_data=(X_test, Y_test), batch_size = 1, epochs = 400, callbacks=[earlystopping])
