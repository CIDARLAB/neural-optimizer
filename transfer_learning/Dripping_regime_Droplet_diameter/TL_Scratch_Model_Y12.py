...
model.add(Dense(units = 16, activation = 'relu', input_dim = 8 , name='scratch_dense_1'))#, kernel_regularizer=regularizers.l2(0.001))) #more options to avoid over-fitting
...
model.add(Dense(units = 1, name='scratch_dense_3'))#, kernel_regularizer=regularizers.l2(0.001)))
...
### Early stopping
earlystopping=EarlyStopping(monitor="mean_squared_error", patience=3, verbose=1, mode='auto')
...
print("\n")
print("Mean absolute error (MAE) for total data-set:      %f" % sklearn.metrics.mean_absolute_error(Y12,y_pred_total))
print("Mean squared error (MSE) for total data-set:       %f" % sklearn.metrics.mean_squared_error(Y12,y_pred_total))
print("Root mean squared error (RMSE) for total data-set: %f" % math.sqrt(sklearn.metrics.mean_squared_error(Y12,y_pred_total)))
print("R square (R^2) for total data-set:                 %f" % sklearn.metrics.r2_score(Y12,y_pred_total))