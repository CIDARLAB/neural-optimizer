...
TUNABLE_MODELS = [
			('Model-00 (Regime Classification)', KerasClassifier(build_fn=createClassifier,
                                        loss_func='binary_crossentropy', opt_func='adam', 
                                        act_hidden='relu',
                                        act_output='sigmoid')),
			('Model-11 (Regime#1-Rate Regression)', KerasRegressor(build_fn=createRegressor, 
                                        loss_func='mean_squared_error', opt_func='adam', 
                                        act_hidden='relu',
                                        act_output='linear')),
			('Model-12 (Regime#1-Size Regression)', KerasRegressor(build_fn=createRegressor,
                                        loss_func='mean_squared_error', opt_func='adam', 
                                        act_hidden='relu',
                                        act_output='linear')),
			('Model-21 (Regime#2-Rate Regression)', KerasRegressor(build_fn=createRegressor,
                                        loss_func='mean_squared_error', opt_func='adam', 
                                        act_hidden='relu',
                                        act_output='linear')),
			('Model-22 (Regime#2-Size Regression)', KerasRegressor(build_fn=createRegressor,
                                        loss_func='mean_squared_error', opt_func='adam', 
                                        act_hidden='relu',
                                        act_output='linear'))
		]
...
NO_TUNABLE_MODELS = [
			...
			('Model-12 (Regime#1-Size Regression)', KerasRegressor(build_fn=createRegressor,
                                        loss_func='mean_squared_error', opt_func='adam', 
                                        batch_size=no_tuning_params['model_12']['batch_size'],
                                        epochs=no_tuning_params['model_12']['epochs'],
                                        num_hidden=no_tuning_params['model_12']['num_hidden'],
                                        node_hidden=no_tuning_params['model_12']['node_hidden'],
                                        act_hidden='relu', act_output='linear')),
			('Model-21 (Regime#2-Rate Regression)', KerasRegressor(build_fn=createRegressor,
                                        loss_func='mean_squared_error', opt_func='adam', 
                                        batch_size=no_tuning_params['model_21']['batch_size'],
                                        epochs=no_tuning_params['model_21']['epochs'],
                                        num_hidden=no_tuning_params['model_21']['num_hidden'],
                                        node_hidden=no_tuning_params['model_21']['node_hidden'],
                                        act_hidden='relu', act_output='linear')),
			('Model-22 (Regime#2-Size Regression)', KerasRegressor(build_fn=createRegressor,
                                        loss_func='mean_squared_error', opt_func='adam', 
                                        batch_size=no_tuning_params['model_22']['batch_size'],
                                        epochs=no_tuning_params['model_22']['epochs'],
                                        num_hidden=no_tuning_params['model_22']['num_hidden'],
                                        node_hidden=no_tuning_params['model_22']['node_hidden'],
                                        act_hidden='relu', act_output='linear'))
		]
